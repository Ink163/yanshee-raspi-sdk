...
class UBTEDU_ROBOTGYRO_SENSOR_T(_object):
    ...
    if _newclass:dValue = _swig_property(_RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dValue_get, _RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dValue_set)
    def __init__(self): 
...
class UBTEDU_ROBOTENV_SENSOR_T(_object):
    ...
    if _newclass:iValue = _swig_property(_RobotApi.UBTEDU_ROBOTENV_SENSOR_T_iValue_get, _RobotApi.UBTEDU_ROBOTENV_SENSOR_T_iValue_set)
    def __init__(self): 
